...
<div id="evcal_4" class="postbox evcal_admin_meta">	
	...
	<div class='evo_addons_page addons'>
		<div class="debugAct" style="text-align:center">
			<p style="font-size:20px;">Activation does not work?</p>
			<p>NOTE: EventON and its addons should work 100% despite it's been activated.</p>
		...
		<?php // ADDONS 
			...
			?>
				...
				<div id='evo_addons_list' data-addons='<?php echo $eventon_addons_opt;?>' data-licenses='<?php echo $evo_licenses;?>' data-url='<?php echo AJDE_EVCAL_URL.'/admin/includes/addon_details.php';?>' data-adminurl='<?php echo $admin_url;?>' data-active_plugins='<?php echo $_activePlugins;?>'>
